                    ...
                    for (var y = rowmaintain; y < roomarray.length; y++)
                    {
                        ...
                        { if(roomarray[y]["leftslot"]===11) {
                           ...
                           if(leftsection<=11)
                           {
                               ...
                               coursearray[x]["leftsection"]= 11-roomarray[y]["leftslot"]
                               roomarray[y]["leftslot"] =  0
